-- Database Schema: supplychaindb
-- Supported Dialect: PostgreSQL / standard SQL
...
-- 4. Warehouse Inventory Table (Composite Key: warehouse_id + product_id)
...
-- Seed Initial Data
-- Passwords below are BCrypt encoded for password 'password123'
...
(1, 1, 100, 0),
(1, 2, 25, 0), -- Low stock alert trigger (< 30)
(1, 3, 80, 0),
(1, 4, 12, 0),
(1, 5, 45, 0),
(2, 1, 40, 0),
(2, 2, 150, 0),
(2, 3, 10, 0), -- Low stock alert trigger (< 20)
(2, 4, 3, 0),  -- Low stock alert trigger (< 5)
(2, 5, 60, 0),
(3, 1, 5, 0),  -- Low stock alert trigger (< 15)
(3, 2, 80, 0),
(3, 3, 120, 0),
(3, 4, 8, 0),
(3, 5, 18, 0)  -- Low stock alert trigger (< 25)
